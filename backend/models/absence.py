...
class Absence(TimestampMixin, Base):
    ...
    absence_type: Mapped[AbsenceType] = mapped_column(Enum(AbsenceType), nullable=False)
    start_date: Mapped[date] = mapped_column(Date, nullable=False, index=True)
    end_date: Mapped[date] = mapped_column(Date, nullable=False, index=True)
    duration_type: Mapped[AbsenceDurationType] = mapped_column(Enum(AbsenceDurationType), nullable=False)
